    ...
    <NavigationContainer>
        ...
        screenOptions={({ route }) => ({
            ...
            if (route.name === "OVERALL") {
                ...
                return (
                <FontAwesome5 name="toilet-paper" size={size} color={color} style={styles.icons} />
                );
            } else if (route.name === "ENTERTAIN") {
                return <FontAwesome5 name="utensils" size={size} color={color} style={styles.icons}/>;
            } else if (route.name === "PERSONAL") {
                return <FontAwesome name="heart" size={size} color={color} style={styles.icons}/>;
            }
            },
        })}
        tabBarOptions={{
